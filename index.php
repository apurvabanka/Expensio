...
<body onload="set()">
	<nav class="navbar fixed-top navbar-expand-md flex-nowrap navbar-new-top">
            <a href="/" class="navbar-brand">Expensio</a>
            <ul class="nav navbar-nav mr-auto"></ul>
            <ul class="navbar-nav flex-row">
                <li class="nav-item">
                    <a class="nav-link px-2">Analytics</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link px-2">Goals</a>
                </li>
                <li class="nav-item">
					...
					<div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
						<div class="our-services-wrapper mb-60">
							<div class="services-inner">
								...
								<div class="our-services-text">
									<h4>Profits</h4>
									<p class="mon"><i class="fa fa-inr" style="font-size:24px"></i>650</p>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="our-services-wrapper mb-60">
							<div class="services-inner">
								...
								<div class="our-services-text">
									...
									<p class="mon"><i class="fa fa-inr" style="font-size:24px"></i>3800</p>
								</div>
							</div>
						</div>
					</div>
